    ...
    <div className="w-full max-w-md mx-auto py-8">
      ...
      <div className="mb-8">
        <button 
          ...
          type="button"
          className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border border-gray-200 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-white/5 transition-all duration-200 font-semibold text-sm text-gray-700 dark:text-gray-300 shadow-sm"
        >
      ...
      <div className="relative mb-8">
        ...
        <div className="relative flex justify-center text-xs uppercase">
          <span className="px-4 text-gray-400 bg-white dark:bg-gray-900">Or use email</span>
        </div>
      </div>
